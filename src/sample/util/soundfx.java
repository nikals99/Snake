...
public class soundfx {
    public void startGame(){
        String musicFile4 = "resources/sounds/start_game.wav";
    ...
    public void picked_nowalls() {
        String musicFile4 = "resources/sounds/picked_nowalls.wav";
        Media picked_nowalls = new Media(new File(musicFile4).toURI().toString());
        MediaPlayer mediaPlayer = new MediaPlayer(picked_nowalls);
        mediaPlayer.play();
    }

    public void picked_slowmotion() {
        String musicFile4 = "resources/sounds/picked_slowmotion.wav";
